...
>
    ...
    >
        ...
        <div class="flex flex-col items-center justify-center py-8">
            <p class="text-lg">{{ __('Are you sure you want to mark this task as completed?') }}</p>
            <div class="flex items-center justify-center space-x-4 mt-8">
                <x-form.button-cancel @click="confirmTaskCompleted = false" />
