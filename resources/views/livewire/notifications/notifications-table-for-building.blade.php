        ...
        <tbody>
            @forelse($notifications as $notification)
                <tr class="bg-gray-100 hover:bg-primary hover:bg-opacity-20 transition duration-200">
                    ...
                    <td
                        x-data="{ confirmDelete: false, confirmCancel: false }" 
                        class="flex items-center space-x-2 py-3 pl-2"
                    >
                        <a href="{{ route('notifications.show', $notification) }}" title="{{ __('View Details')}}">
                        ...
                        <x-modals.confirm-cancel route="{{ route('notifications.cancel', $notification) }}" />
                        <button 
